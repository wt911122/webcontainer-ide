...
`).concat(s)}var mi=function(e){return typeof e=="string"?e.startsWith("/")?e:"/".concat(e):Array.isArray(e)?e.map(function(t){return t.startsWith("/")?t:"/".concat(t)}):typeof e=="object"&&e!==null?Object.entries(e).reduce(function(t,n){var s=n[0],o=n[1],r=s.startsWith("/")?s:"/".concat(s);return t[r]=o,t},{}):null},Us;(function(e){e[e.None=0]="None",e[e.Error=10]="Error",e[e.Warning=20]="Warning",e[e.Info=30]="Info",e[e.Debug=40]="Debug"})(Us||(Us={}));function gi(e,t,n){var s;return n===void 0&&(n={}),ii(this,void 0,void 0,function(){var o,r,i;return li(this,function(l){switch(l.label){case 0:switch(o=(s=t.template)!==null&&s!==void 0?s:"parcel",i=o,i){case"node":return[3,1];case"static":return[3,3]}return[3,5];case 1:return[4,An(()=>import("./index-88165ab2.js"),["assets/index-88165ab2.js","assets/base-80a1f760-a7ab5117.js","assets/consoleHook-cdbe54ab-f282ce09.js"]).then(function(a){return a.SandpackNode})];case 2:return r=l.sent(),[3,7];case 3:return[4,An(()=>import("./index-ec7d9378-b21be09c.js"),["assets/index-ec7d9378-b21be09c.js","assets/consoleHook-cdbe54ab-f282ce09.js","assets/base-80a1f760-a7ab5117.js"]).then(function(a){return a.SandpackStatic})];case 4:return r=l.sent(),[3,7];case 5:return[4,An(()=>import("./index-4f9328df.js"),["assets/index-4f9328df.js","assets/base-80a1f760-a7ab5117.js"]).then(function(a){return a.SandpackRuntime})];case 6:r=l.sent(),l.label=7;case 7:return[2,new r(e,t,n)]}})})}class Ro extends Gr{constructor(){super(...arguments);R(this,"options",{showOpenInCodeSandbox:!1,showErrorScreen:!1,showLoadingScreen:!0})}async launch(){const n=await gi(this.iframe,this.project,this.options);this.client=n,console.log(n)}mutateContentInTemplateBeforeLoad(n){this.project.files[this.filePath]={code:n}}async updateProject(n){this.project.files[this.filePath]={code:n},this.client.updateSandbox(this.project)}}const yi={files:{"/index.html":{code:`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
