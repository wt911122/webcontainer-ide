...
`).concat(s)}var wi=function(e){return typeof e=="string"?e.startsWith("/")?e:"/".concat(e):Array.isArray(e)?e.map(function(t){return t.startsWith("/")?t:"/".concat(t)}):typeof e=="object"&&e!==null?Object.entries(e).reduce(function(t,n){var s=n[0],o=n[1],r=s.startsWith("/")?s:"/".concat(s);return t[r]=o,t},{}):null},Ks;(function(e){e[e.None=0]="None",e[e.Error=10]="Error",e[e.Warning=20]="Warning",e[e.Info=30]="Info",e[e.Debug=40]="Debug"})(Ks||(Ks={}));function _i(e,t,n){var s;return n===void 0&&(n={}),fi(this,void 0,void 0,function(){var o,r,i;return pi(this,function(l){switch(l.label){case 0:switch(o=(s=t.template)!==null&&s!==void 0?s:"parcel",i=o,i){case"node":return[3,1];case"static":return[3,3]}return[3,5];case 1:return[4,Rn(()=>import("./index-c578fe39.js"),["assets/index-c578fe39.js","assets/base-80a1f760-a7ab5117.js","assets/consoleHook-cdbe54ab-79b4080f.js"]).then(function(a){return a.SandpackNode})];case 2:return r=l.sent(),[3,7];case 3:return[4,Rn(()=>import("./index-ec7d9378-d092146a.js"),["assets/index-ec7d9378-d092146a.js","assets/consoleHook-cdbe54ab-79b4080f.js","assets/base-80a1f760-a7ab5117.js"]).then(function(a){return a.SandpackStatic})];case 4:return r=l.sent(),[3,7];case 5:return[4,Rn(()=>import("./index-3c3370f8.js"),["assets/index-3c3370f8.js","assets/base-80a1f760-a7ab5117.js"]).then(function(a){return a.SandpackRuntime})];case 6:r=l.sent(),l.label=7;case 7:return[2,new r(e,t,n)]}})})}class Lo extends oi{constructor(){super(...arguments);M(this,"options",{showOpenInCodeSandbox:!1,showErrorScreen:!1,showLoadingScreen:!0})}async launch(){const n=await _i(this.iframe,this.project,this.options);this.client=n,console.log(n)}mutateContentInTemplateBeforeLoad(n){this.project.files[this.filePath]={code:n}}async updateProject(n){this.project.files[this.filePath]={code:n},this.client.updateSandbox(this.project)}}const xi={files:{"/index.html":{code:`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
